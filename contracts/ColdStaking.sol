...
contract ColdStaking {
    ...
    uint public DateStartStaking = 1540135800;  // 10/21/2018 @ 3:30pm (UTC)
    address public Treasury       = 0x627306090abaB3A6e1400e9345bC60c78a8BEf57; // Callisto Staking Reserve address.
    /*========== end testing values ===================*/
